...
export const IconBook = ({ size, fill, color, strokeWidth = 2 }: IconProps) => {
    return (
        <svg className={color} width={size} height={size} viewBox='0 0 24 24' fill='none'>
            <path
                opacity='0.12'
                d='M2 6.2C2 5.07989 2 4.51984 2.21799 4.09202C2.40973 3.71569 2.71569 3.40973 3.09202 3.21799C3.51984 3 4.07989 3 5.2 3H5.6C7.84021 3 8.96031 3 9.81596 3.43597C10.5686 3.81947 11.1805 4.43139 11.564 5.18404C12 6.03968 12 7.15979 12 9.4V21L11.8999 20.8499C11.2053 19.808 10.858 19.287 10.3991 18.9098C9.99286 18.5759 9.52477 18.3254 9.02161 18.1726C8.45325 18 7.82711 18 6.57482 18H5.2C4.0799 18 3.51984 18 3.09202 17.782C2.71569 17.5903 2.40973 17.2843 2.21799 16.908C2 16.4802 2 15.9201 2 14.8V6.2Z'
                className={fill}
            />
            <path
...
export const IconGlobe = ({ size, fill = "none", color, strokeWidth = 2 }: IconProps) => {
    return (
        <svg className={color} width={size} height={size} viewBox='0 0 24 24' fill='none'>
            <g opacity='0.12'>
                <path
                    d='M17 12C19 10 21 8.20914 21 6C21 3.79086 19.2091 2 17 2C14.7909 2 13 3.79086 13 6C13 8.20914 15 10 17 12Z'
                    className={fill}
                />
                <path
                    d='M10.5001 21.8883L10.5002 19.6849C10.5002 19.5656 10.5429 19.4502 10.6205 19.3596L13.1063 16.4594C13.3106 16.2211 13.2473 15.8557 12.9748 15.6999L10.1185 14.0678C10.0409 14.0234 9.97663 13.9591 9.93234 13.8814L8.07046 10.6187C7.97356 10.4488 7.78657 10.3511 7.59183 10.3684L2.06418 10.8608C2.02178 11.2347 2 11.6148 2 12C2 17.0131 5.68876 21.1646 10.5001 21.8883Z'
                    className={fill}
                />
            </g>
            <path
...
export const IconLightbulb = ({ size, fill, color, strokeWidth = 2 }: IconProps) => {
    return (
        <svg className={color} width={size} height={size} viewBox='0 0 24 24' fill='none'>
            <path
                opacity='0.12'
                d='M15.5 16.874C17.0141 15.7848 18 14.0075 18 12C18 8.68629 15.3137 6 12 6C8.68629 6 6 8.68629 6 12C6 14.0075 6.98593 15.7848 8.5 16.874V18.8C8.5 19.9201 8.5 20.4802 8.71799 20.908C8.90973 21.2843 9.21569 21.5903 9.59202 21.782C10.0198 22 10.5799 22 11.7 22H12.3C13.4201 22 13.9802 22 14.408 21.782C14.7843 21.5903 15.0903 21.2843 15.282 20.908C15.5 20.4802 15.5 19.9201 15.5 18.8V16.874Z'
                fill={fill}
            />
            <path
...
export const IconTicket = ({ size, fill = "none", color, strokeWidth = 2 }: IconProps) => {
    return (
        <svg className={color} width={size} height={size} viewBox='0 0 24 24' fill='none'>
            <path
                opacity='0.12'
                d='M18.8 4H5.2C4.0799 4 3.51984 4 3.09202 4.21799C2.71569 4.40973 2.40973 4.71569 2.21799 5.09202C2 5.51984 2 6.0799 2 7.2V8.5C3.933 8.5 5.5 10.067 5.5 12C5.5 13.933 3.933 15.5 2 15.5V16.8C2 17.9201 2 18.4802 2.21799 18.908C2.40973 19.2843 2.71569 19.5903 3.09202 19.782C3.51984 20 4.0799 20 5.2 20H18.8C19.9201 20 20.4802 20 20.908 19.782C21.2843 19.5903 21.5903 19.2843 21.782 18.908C22 18.4802 22 17.9201 22 16.8V15.5C20.067 15.5 18.5 13.933 18.5 12C18.5 10.067 20.067 8.5 22 8.5V7.2C22 6.0799 22 5.51984 21.782 5.09202C21.5903 4.71569 21.2843 4.40973 20.908 4.21799C20.4802 4 19.9201 4 18.8 4Z'
                className={fill}
            />
            <path
    ...
    return (
        <svg className={color} width={size} height={size} viewBox='0 0 24 24' fill='none'>
            <path
                className={fill}
                opacity='0.12'
                d='M2 12.5C2 10.1564 3.79151 8.23129 6.07974 8.01937C6.54781 5.17213 9.02024 3 12 3C14.9798 3 17.4522 5.17213 17.9203 8.01937C20.2085 8.23129 22 10.1564 22 12.5C22 14.0602 21.206 15.435 20 16.2422H16V16L12 12.2422L8 16V16.2422H4C2.79401 15.435 2 14.0602 2 12.5Z'
            />
            <path
    ...
    return (
        <svg className={color} width={size} height={size} viewBox='0 0 24 24' fill='none'>
            <g opacity='0.12'>
                <path
                    className={fill}
                    d='M17.2 2C18.8802 2 19.7202 2 20.362 2.32698C20.9265 2.6146 21.3854 3.07354 21.673 3.63803C22 4.27976 22 5.11984 22 6.8V7L2 7L2 6.8C2 5.11984 2 4.27976 2.32698 3.63803C2.6146 3.07354 3.07354 2.6146 3.63803 2.32698C4.27976 2 5.11984 2 6.8 2L17.2 2Z'
                />
                <path
                    className={fill}
                    d='M17.2 22C18.8802 22 19.7202 22 20.362 21.673C20.9265 21.3854 21.3854 20.9265 21.673 20.362C22 19.7202 22 18.8802 22 17.2V17L2 17L2 17.2C2 18.8802 2 19.7202 2.32698 20.362C2.6146 20.9265 3.07354 21.3854 3.63803 21.673C4.27976 22 5.11984 22 6.8 22H17.2Z'
                />
            </g>
            <path
...
export const IconStopwatch = ({ size, fill, color, strokeWidth = 2 }: IconProps) => {
    return (
        <svg className={color} width={size} height={size} viewBox='0 0 24 24' fill='none'>
            <path
                className={fill}
...
export const IconArrow = ({ size, fill, color, strokeWidth = 2, direction }: IconProps) => {
    switch (direction) {
        case "left":
            return (
                <svg className={color} width={size} height={size} viewBox='0 0 24 24' fill='none'>
...
export const IconMail = ({ size, fill, color, strokeWidth = 2 }: IconProps) => {
    return (
        <svg className={color} width={size} height={size} viewBox='0 0 24 24' fill='none'>
            <path
                opacity='0.12'
...
export const IconKey = ({ size, fill, color, strokeWidth = 2 }: IconProps) => {
    return (
        <svg className={color} width={size} height={size} viewBox='0 0 24 24' fill='none'>
            <path
                opacity='0.12'
...
export const IconTranslate = ({ size, fill, color, strokeWidth = 2 }: IconProps) => {
    return (
        <svg className={color} width={size} height={size} viewBox='0 0 24 24' fill='none'>
            <path
