...
export function Button({ size, width, type, text, icon, url, onclick, formType, disabled }: ButtonProps) {
    ...
    switch (type) {
        case 'primary':
            ...
            break;
        case 'secondary-gray':
            buttonTypeStyle = "bg-white shadow-sm text-gray-800 border border-gray-200 dark:border-dark-600 dark:text-white hover:bg-gray-50 dark:hover:bg-dark-700 focus:outline outline-gray-100 dark:outline-dark-600";
            break;
