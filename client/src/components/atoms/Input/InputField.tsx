      ...
      {disabled ? (
        <div className="relative flex items-center text-gray-900 w-full drop-shadow-sm">
          ...
          <Field
            ...
            id={id}
            name={name}
            className={`${inputFieldStyle} ${inputFieldBorderStyle} cursor-not-allowed text-gray-500 w-full bg-gray-50 border rounded-lg placeholder:text-gray-400 px-3.5 py-2.5 text-md font-normal dark:bg-dark-800 dark:text-gray-200`}
          ></Field>
        </div>
      ) : (
        <div className="relative flex items-center text-gray-900 w-full drop-shadow-sm">
          ...
          <Field
            ...
            id={id}
            name={name}
            className={`${inputFieldStyle} ${inputFieldBorderStyle} w-full bg-white border rounded-lg placeholder:text-gray-400 px-3.5 py-2.5 text-md font-normal dark:bg-dark-700 dark:text-white`}
          ></Field>
        </div>
      )}
    </>
