      ...
      {disabled ? (
        <div className="relative flex items-center text-gray-900 w-full drop-shadow-sm">
          <Field
            ...
            as="textarea"
			rows={5}
            className={`${inputFieldStyle} ${inputFieldBorderStyle} cursor-not-allowed w-full bg-white border rounded-lg placeholder:text-gray-300 px-3.5 py-2.5 text-md font-normal dark:bg-dark-800 dark:text-white`}
          ></Field>
        </div>
      ) : (
        <div className="relative flex items-center text-gray-900 w-full drop-shadow-sm">
          <Field
            ...
            as="textarea"
			rows={5}
            className={`${inputFieldStyle} ${inputFieldBorderStyle} w-full bg-white border rounded-lg placeholder:text-gray-300 px-3.5 py-2.5 text-md font-normal dark:bg-dark-800 dark:text-white`}
          ></Field>
        </div>
      )}
    </>
