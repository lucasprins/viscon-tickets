		...
		<div className='flex items-center justify-center w-screen h-screen p-6 lg:p-8 dark:bg-dark-800'>
			<div className='flex flex-col gap-12'>
				...
				<div className='flex flex-col items-center gap-6'>
					...
					<div className='flex flex-col items-center gap-6'>
						<h1 className='font-semibold text-center text-gray-900 text-display_md lg:text-display_xl dark:text-white'>{translations[language].title}</h1>
						<p className='text-xl text-center text-gray-600 dark:text-dark-400'>{translations[language].subtitle}</p>
					</div>
				</div>
				{/* Actions Desktop */}
