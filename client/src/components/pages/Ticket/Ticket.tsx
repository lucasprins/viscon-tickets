                                                ...
                                                <Form className='flex flex-col gap-5 w-full'>
                                                    ...
                                                    <div className='flex flex-col w-full gap-1.5'>
                                                        ...
                                                        <InputTextArea
                                                            ...
                                                            name='issue'
                                                            placeholder={
                                                                translations[language].describe_placeholder_specific
                                                            }
                                                        />
                                                    ...
                                                    <div className='flex flex-col w-full gap-1.5'>
                                                        ...
                                                        <InputTextArea
                                                            ...
                                                            placeholder={
                                                                translations[language].describe_placeholder_tried
                                                            }
                                                        />
                                                    ...
                                                    <div className='flex flex-col w-full gap-1.5'>
                                                        ...
                                                        <InputTextArea
                                                            ...
                                                            name='extraInfo'
                                                            placeholder={
                                                                translations[language].describe_placeholder_extra_info
                                                            }
                                                        />
