...
export function NavigationAdminMenu() {
  ...
  if (userRole === "CustomerAdmin") {
    navigationItems = [
      <NavigationItem
        name={translations[language].manage_users}
        url='admin/users'
        icon={<IconUsers size='24' color='stroke-gray-500 dark:stroke-gray-300' fill='fill-gray-500' />}
      />,
    ];
    ...
    navigationItems = [
      ...
      />,
      <NavigationItem
        name={translations[language].manage_companies}
        url='admin/companies'
        icon={<IconBuilding size='24' color='stroke-gray-500 dark:stroke-gray-300' fill='fill-gray-500' />}
      />,
      <NavigationItem
        name={translations[language].manage_machines}
        url='admin/machines'
        icon={<IconGear size='24' color='stroke-gray-500 dark:stroke-gray-300' fill='fill-gray-500' />}
      />,
      <NavigationItem
        name={translations[language].manage_solutions}
        url='admin/solutions'
        icon={<IconLightbulb size='24' color='stroke-gray-500 dark:stroke-gray-300' fill='fill-gray-500' />}
      />,
    ];
  }
  ...
  return (
    <Disclosure>
      {({ open }) => (
        <>
          <div className='flex rounded-md hover:bg-gray-100 dark:hover:bg-dark-700'>
            <Disclosure.Button className='flex items-center justify-between w-full px-3 py-2'>
