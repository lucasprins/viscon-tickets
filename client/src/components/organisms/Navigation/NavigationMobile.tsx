...
import { IconMenu } from '../../atoms/Icons/Icons'
...
export const NavigationMobile = ({ openSidebar }: NavigationMobileTypes) => {
	return (
		<>
			<div className='z-10 drop-shadow-sm sticky inset-0 bg-white dark:bg-dark-700 dark:border-dark-500 flex items-center md:hidden justify-between py-3 pr-3 pl-6 border-b border-gray-200'>
				<Link to='/'>
