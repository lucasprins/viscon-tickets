                        ...
                        <tbody className=''>
                            {table.getRowModel().rows.map((row) => (
                                <tr
                                    ...
                                    key={row.id}
                                    className='odd:bg-gray-50 hover:odd:bg-gray-100 hover:even:bg-gray-200 cursor-pointer even:bg-white dark:odd:bg-dark-700 dark:even:bg-dark-800 dark:hover:odd:bg-dark-600 dark:hover:even:bg-dark-700 border-b border-gray-200 dark:border-dark-600'
                                >
