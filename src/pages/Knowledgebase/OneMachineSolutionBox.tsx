...
export default function OneMachineSolution({solution, issue}:solutionProps) {
  return (
    ...
    <div className='p-5 border-solid border border-gray-100 rounded-lg drop-shadow-md w-full '>
      <h3 className=' text-gray-900 font-medium'>{issue}</h3>
      <p className=' text-gray-600 font-normal'>{solution}</p>
    ...
    {/* Later when tags are implemented text below will be replaced by calling the tags function and give the correct values. For now hardcoded */}
      <div className='' >
        ...
        <p className='text-gray-700 font-medium'> Satelliet shuttle</p>
        </div>
        
        <div className='pt-5 border-solid border border-gray-300 rounded-lg inline-flex'>
          <p className='text-gray-700 font-medium'>Tekeningnummer: 5001483</p>
        </div>
      </div> 
