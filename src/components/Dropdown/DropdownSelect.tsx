    ...
    return (
        <div>
            <Listbox value={selectedMachine} onChange={setSelectedMachine}>
                ...
                <Listbox.Button className=' focus:outline-4 dark:outline-0 outline-primary-200 w-full rounded-lg mb-2 flex border bg-white text-gray-800 font-medium shadow-sm border-gray-200 py-2.5 px-3.5 dark:text-white dark:font-normal dark:border-dark-500 dark:bg-dark-700'>
                    {({ open }) => (
