...
export const NavigationMobile = ({openSidebar}: NavigationMobileTypes) => {
	...
	return (
		<>
			<div className='sticky inset-0 bg-white dark:bg-dark-700 dark:border-dark-500 flex items-center md:hidden transition-all justify-between py-3 pr-3 pl-6 border-b border-gray-200'>
